...
if (isset($_REQUEST['btn_insert'])){
        ...
        $query = "INSERT INTO request(name1,employee_id,indoc,degree,depart,document_number,document_name,effective_date,request,cause,page_edit,information_edit,about_edit,file_name_upload,document_status,sub_id) 
        values('$name1','$employee_id','$indoc','$degree','$depart','$document_number','$document_name','$date','$request','$cause','$page_edit','$information_edit','$about_edit','$fileName','$document_status','$bytes')";
        ...
        $query = "INSERT INTO request(name1,employee_id,indoc,degree,depart,document_number,document_name,effective_date,request,cause,page_edit,information_edit,about_edit,file_name_upload,document_status,sub_id) 
        values('$name1','$employee_id','$indoc','$degree','$depart','$document_number','$document_name','$effective_date','$request','$cause','$page_edit','$information_edit','$about_edit','$fileName','$document_status','$bytes')";
        $run_query = mysqli_query($con,$query);
        //$sql = "INSERT INTO request ('name1','degree,'document_number','document_name','effective_date')"
        move_uploaded_file($_FILES['file_name_upload']['tmp_name'], $targetFilePath);
