...
<body>
  ...
  <?php } ?> 
    ...
    <button type="button" class=" btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">เพิ่มระดับ</button>
  </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">เพิ่ม ระดับ SUPER</h5>
        ...
        <div class="modal-footer">
          <input type="submit" name="btn_superdegree" class="btn btn-primary" value="เพิ่มระดับ">
        </div>
      </div>
    </div>
  </div>
  ...
  function myConfirm(id) {
    Swal.fire({
      ...
      if (result.value) {
        ...
        window.location.href = `../C/delete_super_degree.php?id=${id}`
