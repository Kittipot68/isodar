                ...
                <fieldset class="border rounded p-3 row">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                                ...
                                <input disabled value="<?php echo $row2['effective_date'];?>" type="text"  name="" class="form-control">
                        </div>
                    </div>
                    <div class="mt-4 row">
                        <div class="col-md-4">
 ...
 ?>
                ...
                <fieldset  class="border rounded p-3 row">
                    ...
                    <div class="col-md-3">
                            ...
                            <input required value="" type="date"  name="noti_date" class="form-control">
                    </div>
                    <div class="col-md-3">
                            <label for="edit_date" class="form-label">วันเดือนปีที่แก้ไขเสร็จ</label>
                            <input required value="" type="date"  name="edit_date" class="form-control">
                    </div>
                    <div class="col-md-3">
                            <label for="master_date" class="form-label">วันเดือนปีที่ลง Master list</label>
                            <input required value="" type="date"  name="master_date" class="form-control">
                    </div>
                    <div class=" col-md-3">
                            <label for="delete_date" class="form-label">ว.ด.ปที่ Delete ฉบับก่อนแก้ไข</label>
                            <input required value="" type="date"  name="delete_date" class="form-control">
                    </div>
                    <div class="mt-3 col-md-3">
                            <label for="effective_date" class="form-label">วันที่มีผลบังคับใช้</label>
                            <input required value="" type="date"  name="effective_date_qs" class="form-control">
                    </div>

                    <div class="mt-3 col-md-3">
                            <label for="cancellation_date" class="form-label">วันที่ยกเลิก</label>
                            <input  value="" type="date"  name="cancellation_date" class="form-control">
                    </div>
                    ...
                    <div class="mt-3 col-md-1">
                            ...
                            <input  value="" type="text"  name="rev" class="form-control">
                    </div>
                    <div  class="mt-3 col-md-3">
                            <label for="qs_name" class="form-label">ลงชื่อเจ้าหน้าที่QS</label>
                            <input required value="" type="text" name="qs_name" class="form-control">
                    ...
                    <div class="mb-5 form-group text-center">
                        ...
                        <!--<input type="submit" name="btn_insert" class="btn btn-success" value="บันทึก">-->
                            <a href="admin_assign.php" class="btn btn-danger">Cancel</a>
                        </div>
                    </div>
                </div>
