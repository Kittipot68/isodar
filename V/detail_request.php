...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
            <div class="row mt-2">
                ...
                <fieldset class="border rounded p-3 row">
                    <div class="row">
                        <div class=" document_number col-md-4">
                        ...
                        <div class="document_name col-md-4">
                    ...
                    <div class="mt-4 row">
                        <div class="col-md-4">
                            ...
                            <input id="request" disabled value="<?php echo $row2['request']; ?>" type="text" name="request" class="form-control">
                        </div>
                        <div class="cause col-md-5">
                        ...
                        <div  class="cause_other col-md-12 mt-4" >
                            <label for="" class="form-label">สาเหตุอื่นๆ</label>
                            <textarea disabled required  type="text" name="cause" class="form-control"><?php echo $row2['cause_other']; ?></textarea>
                        </div>
                    ...
                    <div class="content3 mt-4">
                        <div class="col-md-12">
                            ...
                            <textarea disabled rows="5"  type="text" name="information_edit" id="information_edit" class="form-control"><?php echo $row2['information_edit']; ?></textarea>
                        </div>
                    </div>
                    <!-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
                    <!-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
                    <!-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
                    <!-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------->
                    <div   class="upload row content4 mt-4">
                        <div class="qwp col-md-4 mt-1">
...
<script>
  ...
  var inputValue = $("#request").val();

  if (inputValue === "ยกเลิก") {
    $(".upload").hide();
    $(".page_edit").hide();
